...
/**
 * view util to show parallax scroll view on image for location Choice details page
 *
 * @author tejoa
 */

public class ParallaxScollView extends ListView implements AbsListView.OnScrollListener {
